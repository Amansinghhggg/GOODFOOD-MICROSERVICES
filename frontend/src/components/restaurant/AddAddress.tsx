...
longitude]} />}
	...
	<p className="mt-2 text-sm text-red-600">Please click "Use current location" or click on the map to get an accurate location.</p>

<input
	type="text"
	placeholder="Room No, Building, etc."
	value={inputAddress}
