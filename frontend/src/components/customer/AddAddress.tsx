...
const LocateMeButton = ({ onLocate }: { onLocate: (lat: number, lng: number) => void }) => {
  ...
  return (
    <button
      onClick={locateUser}
      className="absolute right-3 top-3 z-[1000] flex items-center gap-2 rounded-xl border border-white bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-lg transition hover:bg-rose-50 hover:text-[#E23774]"
    >
