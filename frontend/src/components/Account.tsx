      ...
      <div className="bg-linear-to-r from-[#E23774] via-[#f65d95] to-[#ff8a5c] px-6 py-8 text-white sm:px-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-white/75">My Account</p>
              <h1 className="mt-2 text-3xl font-extrabold sm:text-4xl">{user.name}</h1>
              <p className="mt-1 text-sm text-white/80">Manage your profile and session.</p>
            </div>
          </div>
      ...
      <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-4 rounded-3xl border border-orange-100 bg-orange-50/40 p-6">
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium capitalize text-slate-800">{user.role || "Role not selected"}</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-dashed border-orange-200 bg-white px-4 py-4 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Current Area</p>
        ...
        <div className="space-y-6">
          <div className="rounded-3xl bg-slate-900 p-6 text-white shadow-lg">
            <p className="text-sm uppercase tracking-[0.3em] text-white/50">Account Summary</p>
            <div className="mt-6 space-y-4">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-white/50">User ID</p>
                <p className="mt-1 break-all text-sm text-white/90">{user._id}</p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-white/50">Login Status</p>
          ...
          <div className="rounded-3xl border border-orange-100 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Keep track of what you ordered recently.</p>
                </div>
              </div>
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-2xl border border-dashed border-orange-200 bg-orange-50/40 p-4">
                <p className="font-medium text-slate-900">No recent orders yet</p>
                <p className="mt-1 text-sm text-slate-500">Your order history will appear here after you place your first order.</p>
              </div>
            </div>
          </div>
