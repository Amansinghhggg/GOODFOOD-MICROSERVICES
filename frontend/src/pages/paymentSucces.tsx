...
const PaymentSuccess = () => {
  ...
  return (
    <main className="min-h-[calc(100vh-5rem)] bg-brand-cream px-4 py-10 sm:px-6 lg:px-8">
      <div className="relative mx-auto flex min-h-[calc(100vh-7rem)] max-w-lg items-center justify-center">
        <section className="w-full overflow-hidden rounded-3xl border border-brand-border/60 bg-brand-card shadow-premium-lg">
          {/* Top banner */}
          <div className="relative overflow-hidden bg-gradient-to-br from-brand-secondary to-[#2d5d45] px-8 py-10 text-white">
            ...
            <div className="relative">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-sm shadow-premium-sm">
          ...
          <div className="space-y-5 px-8 py-7">
            {paymentId && (
              <div className="rounded-xl border border-brand-border bg-brand-cream-dark/50 p-4 shadow-premium-sm">
                <p className="text-[10px] font-bold uppercase tracking-wider text-brand-muted">Payment Reference</p>
                <p className="mt-1.5 break-all font-mono text-xs text-brand-charcoal font-semibold">{paymentId}</p>
              </div>
            )}
            ...
            <p className="text-center text-[10px] text-brand-muted/70 leading-normal">
